...
export const api = {
  ...
  transactions: (params?: { month?: string; year?: number; category?: string; subcategory?: string; clean_description?: string; uncleaned?: boolean; sort_by?: string; sort_dir?: "asc" | "desc"; limit?: number; offset?: number }) => {
    ...
    if (params?.uncleaned) qs.set("uncleaned", "true");
